    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div>
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-3 rounded-md bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#C8A96E] focus:ring-1 focus:ring-[#C8A96E] transition-all"
        />
      </div>
