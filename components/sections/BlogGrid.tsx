    ...
    <>
      ...
      <div className="mb-16">
        <motion.div 
          ...
          className="relative rounded-[2rem] overflow-hidden group shadow-2xl hover:shadow-3xl transition-shadow duration-700 bg-white border border-gray-100"
        >
          <div className="flex flex-col lg:flex-row h-full">
            {/* Image Section */}
            <div className="relative w-full lg:w-[55%] lg:min-h-[300px] overflow-hidden bg-[#004e2a]">
            ...
            {/* Content Section */}
            <div className="relative w-full lg:w-[45%] p-8 lg:p-10 flex flex-col justify-center bg-white z-10">
              <div className="flex gap-4 items-center mb-6">
                <span className="text-[#006437] bg-[#006437]/5 px-3 py-1 rounded-full uppercase tracking-[0.2em] text-[10px] font-bold shadow-sm border border-[#006437]/10">
                  {featured.category || 'Featured'}
                </span>
              </div>
              
              <h2 className="text-2xl lg:text-4xl font-playfair font-bold text-gray-900 mb-4 leading-tight group-hover:text-[#006437] transition-colors duration-500">
                <Link href={`/blog/${featured.slug.current}`} className="before:absolute before:inset-0">
                  {featured.title}
                </Link>
              </h2>
              
              <p className="text-gray-500 mb-8 text-base leading-relaxed line-clamp-3 font-normal">
                {featured.excerpt}
              </p>
              
              <div className="mt-auto flex items-center justify-between text-xs text-gray-400 font-semibold tracking-wide border-t border-gray-100 pt-6">
                ...
                <span className="flex items-center gap-2 group-hover:text-[#C8A96E] transition-colors">
                  Read Article <span className="text-base leading-none">&rarr;</span>
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col flex-grow px-2">
              ...
              <Link href={`/blog/${post.slug.current}`}>
                <h3 className="font-playfair text-xl font-bold text-gray-900 mb-3 group-hover:text-[#006437] transition-colors leading-snug line-clamp-2">
                  {post.title}
                </h3>
              </Link>
              ...
              <div className="flex justify-between items-center text-[10px] text-gray-400 font-bold tracking-wider pt-4 border-t border-gray-100 w-full mt-auto">
